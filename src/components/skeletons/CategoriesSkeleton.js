...
function CategoriesSkeleton() {
  return (
    <div className="flex-col items-center justify-center ">
      <div className="relative animate-pulse   space-y-3 overflow-hidden   p-3 before:absolute before:inset-0 before:-translate-x-full before:bg-gradient-to-r before:from-transparent before:via-white/20  before:animate-[shimmer_1.5s_infinite]">
        <div className=" h-4 w-24 md:mx-10   bg-neutral-400"></div>
